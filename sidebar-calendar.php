		...
		<div id="secondary" class="fourcol last" role="complementary">
            ...
            <aside id="recordings" class="widget widget_recordings">
	            ...
	            <ul class="recordings">
                    ...
                    <li class="recording">
                    	<a href="#" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyeleven' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">Some other event</a>
                    </li>
                    <li class="recording">
                    	<a href="#" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyeleven' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">Some event</a>
                    </li>
            	</ul>
            </aside>
